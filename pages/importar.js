...
const BAIRROS_CURITIBA = [
  ...
  'Atuba','Augusta','Bacacheri','Bairro Alto','Barreirinha','Bigorrilho','Boa Vista','Bom Retiro',
  ...
  return (
    <Layout title="Importar OS pelo WhatsApp">
      <div style={{maxWidth:640,margin:'0 auto'}}>
        ...
        {/* PASSO 1 — MODELO */}
        <div style={{background:t.bgCard,border:'1px solid '+t.border,borderRadius:16,boxShadow:t.shadow,padding:20,marginBottom:16}}>
