      ...
      <div style={{display:'flex',flexDirection:'column',minHeight:'100vh',background:t.bg,color:t.text,fontFamily:'inherit'}}>
        <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'10px 16px',background:t.bgCard,borderBottom:'1px solid '+t.border,position:'sticky',top:0,zIndex:50}}>
          <div style={{display:'flex',alignItems:'center',gap:8}}>
            ...
            <div>
              <div style={{fontSize:13,fontWeight:700,color:t.text,lineHeight:1.1}}>Top Eletro</div>
              <div style={{fontSize:10,color:t.accent,fontWeight:600}}>Inova</div>
            </div>
          </div>
    ...
    <div style={s.app}>
      <div style={s.sidebar}>
        <div style={s.brandArea}>
          ...
          <div><div style={s.brandName}>Top Eletro</div><div style={s.brandSlogan}>Inova</div></div>
        </div>
        <nav style={s.nav}>
          {nav.map(item => (
        ...
        {temaAberto&&(
          <div style={s.popover}>
            ...
            <div style={{display:'flex',gap:10,alignItems:'center'}}>
              <div style={s.colorDot('#1D9E75',accent==='verde')} onClick={()=>changeAccent('verde')}/>
              <div style={s.colorDot('#2563EB',accent==='azul')} onClick={()=>changeAccent('azul')}/>
            </div>
          </div>
        )}
